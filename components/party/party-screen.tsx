      ...
      {projection.phase === "lobby" ? (
        <PaperPanel tone="display" className="overflow-hidden p-7 lg:p-10">
          <div className="grid items-center gap-8 lg:grid-cols-[1.15fr_0.85fr]">
            ...
            <div className="mx-auto grid aspect-square w-full max-w-sm place-items-center rounded-[1.5rem] border-4 border-dashed border-party-blue/45 bg-surface-sky/70 text-center shadow-outline">
              <div className="space-y-3">
