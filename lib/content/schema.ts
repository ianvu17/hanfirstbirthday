...
const ScreensSchema = z.object({
  ...
  partyPhoto: z.object({
    ...
    savingTitle: LocalizedStringSchema,
    preparingPhoto: LocalizedStringSchema,
    uploadingPhoto: LocalizedStringSchema,
    savingAvatar: LocalizedStringSchema,
    avatarReady: LocalizedStringSchema,
    cancelUpload: LocalizedStringSchema,
    uploadCancelled: LocalizedStringSchema,
    retryUpload: LocalizedStringSchema,
    processingProgress: LocalizedStringSchema,
    ...
    addSticker: LocalizedStringSchema,
    presets: z.object({
      birthdayBear: LocalizedStringSchema,
      birthdayBunny: LocalizedStringSchema,
      birthdayLion: LocalizedStringSchema,
      birthdayPanda: LocalizedStringSchema,
      birthdayKoala: LocalizedStringSchema,
      birthdayTiger: LocalizedStringSchema,
      birthdayStar: LocalizedStringSchema,
      birthdayCupcake: LocalizedStringSchema,
    }),
    stickers: z.object({
  ...
  onboardingNavigation: z.object({
    back: LocalizedStringSchema,
    backDuringUpload: LocalizedStringSchema,
  }),
  quizStart: z.object({
    title: LocalizedStringSchema,
    description: LocalizedStringSchema,
